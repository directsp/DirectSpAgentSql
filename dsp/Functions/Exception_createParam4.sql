...
BEGIN
    ...
    -- set default exception, useful when DirectSp has not been initialized yet
    IF (@exceptionName IS NULL AND  @exceptionId = dsp.ExceptionId_general())
        SET @exceptionName = 'General';
